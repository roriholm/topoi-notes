...
\section{Completeness}
    ...
    \begin{exercise}
        Working in a category with pullbacks and products, and
        ...
        \end{tikzcd}\]
        Then we can find the two product arrows
        % https://q.uiver.app/?q=
        \[\begin{tikzcd}
            && {a} \\
            \\
            {a} && {a \times b} && {b}
            ...
            \arrow[from=3-3, to=3-1]
            \arrow["{1_a}"', from=1-3, to=3-1]
            \arrow[from=1-3, to=3-3, shift right=1, dashed]
            \arrow[from=1-3, to=3-3, shift left=1, dashed]
        \end{tikzcd}\]
        $\langle 1_a, f \rangle$ and $\langle 1_a, g \rangle$. Since they share a codomain we can form the pullback:
